...
module.exports = {
  ...
  'privacy.resistFingerprinting.reduceTimerPrecision.microseconds': false,
  ...
  */
  ...
  'toolkit.telemetry.shutdownPingSender.enabledFirstSession': true,
  'toolkit.telemetry.firstShutdownPing.enabled': true,
  'toolkit.telemetry.healthping.enabled': true,
  'toolkit.telemetry.prioping.enabled': true,

  /* Extra Telemetry Knobs */
  //'toolkit.telemetry.server': "https://localhost",
  //'toolkit.telemetry.minSubsessionLength': 6,
  //'toolkit.telemetry.idleTimeout': 10,
  //'services.sync.telemetry.submissionInterval': 30,

  /* Enable/Disable FHR */
  'datareporting.healthreport.service.enabled': false,
  'datareporting.healthreport.dataSubmissionEnabled': true,
